...
function setUI() {
  ...
  if (furnishMode || arrivalScene) {   // furnish mode / the arrival ceremony take over — chrome hides, canvas carries it
    ...
    $('whisper').classList.toggle('hidden', !!furnishMode);   // the arrival narrates through the whisper — keep it
    return;
  }
